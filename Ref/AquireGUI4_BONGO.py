...
class HDR_DIALOG ( wx.Dialog ):
        ...
        def __init__( self, parent ):
                ...
                self.SHIP = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 35,-1 ) )
...
#                self.TRIP = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 45,-1 ), wx.TE_READONLY )
                self.TRIP = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 45,-1 ) )
                ...
                self.STN = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 45,-1 ) )
                ...
                self.Save_n_Exit_Button = wx.Button( self, wx.ID_SAVE, u"Save and Exit", wx.DefaultPosition, wx.DefaultSize, 0 )
...
################ ALLOW ENTER KEY TO FUNCTION THE SAME AS TAB KEY
                ...
                self.Centre( wx.BOTH )
# Disable ESc key from normal ehavior of cancel-clear                
                self.SetEscapeId(wx.ID_SAVE)
