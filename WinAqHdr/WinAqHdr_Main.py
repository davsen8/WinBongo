...
#  May 15 2018 - DRS - Unpdated to wiork under python 3.65 32bit and wxpython pheonix V 4.0.1.
import wx
import os,sys
 
#import the created GUI file and Parser
import WinAqHdr_GUI
import WinAqHdr_Parse_Nafc_EDF_Hdr as ParseNafcHdr

 
#inherit from the MainFrame created in wxFowmBuilder and create CalcFrame
class EditHdr(WinAqHdr_GUI.HDR_DIALOG):
    #constructor
    def __init__(self,parent,filename,Hdr1dict,Hdr8dict):
        #initialize parent class        
        WinAqHdr_GUI.HDR_DIALOG.__init__(self,parent)
...
#defaultDir=os.getcwd()
        dialog = wx.FileDialog(None, message="Choose a file",defaultDir="c:/CTDDATA", wildcard=wildcard,style=wx.FD_OPEN|wx.FD_FILE_MUST_EXIST)
